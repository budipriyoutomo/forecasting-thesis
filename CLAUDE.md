# CLAUDE.md — ForecastIQ

> Instruksi lengkap untuk project ini ada di **`AGENTS.md`** (root repo) — itu adalah file kanonik yang dipakai lintas AI coding assistant (Claude Code, dan lainnya).
>
> Baca urutan berikut sebelum coding apapun:
> 1. `AGENTS.md` — instruksi wajib (TDD, API standard, Auto Model Selection Engine, larangan, checklist PR)
> 2. `docs/PRD.md` — requirement produk
